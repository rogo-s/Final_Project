...
import com.rogo.final_project.databinding.FragmentCheckoutDepatureDetailBinding
import com.rogo.final_project.viewmodel.DetailViewModel
import com.rogo.final_project.viewmodel.HomeViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class CheckoutDepatureDetail : Fragment() {
    lateinit var binding : FragmentCheckoutDepatureDetailBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCheckoutDepatureDetailBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
